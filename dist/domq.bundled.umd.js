/**
 * domq v0.0.0 | 07-10-2020 - MIT License
 */
...
(function (global, factory) {
	...
	function isdomQ (instance) {
	  return instance instanceof domQ;
	}
	...
	var domQ = /*#__PURE__*/function () {
	  function domQ(selector, context) {
	    if (!selector) {
	      return;
	    }
	    ...
	    if (isString(selector)) {
	      var ctx = (isdomQ(context) ? context[0] : context) || doc;
	...
	function elemAnimation (instance, internalCallback, keyframes, speed, easing, callback) {
	  var options = {};
	  ...
	  return instance.each(function (i, el) {
	    var _el = core(el);

	    var animate = new Promise(function (resolve) {
	      var instance = el.animate(keyframes, options);

	      instance.onfinish = function () {
	...
	function getCompareFunction(comparator) {
	  return isString(comparator) ? function (i, ele) {
	    return core.is(ele, comparator);
	  } : isFunction(comparator) ? comparator : isdomQ(comparator) ? function (i, ele) {
	...
	fn.highlight = function (color, prop, speed, easing, callback) {
	  if (color === void 0) {
	    color = '#ffff9c';
	  }
	  ...
	  return this.each(function (i, ele) {
	    ...
	    var el = core(ele);
	    el.animate((_el$animate = {
	      direction: 'alternate',
	      iterations: 2
	    }, _el$animate[prop] = [el.css(prop), color], _el$animate), speed, easing, callback);
	  });
	};
	...
	fn.scale = function (percent, speed, easing, callback) {
	  ...
	  return elemAnimation(this, function (el) {
	    return el.css(prop);
	...
	function attrHandler$1 (el, token) {
	  var status = true,
	      action = token.action,
	...
	function filterElement(element, token) {
	  if (!isUndefined(token)) {
	    switch (token.type) {
	      case 'attr':
	        return attrHandler$1(element, token);
	...
	core.is = function (ele, selector) {
	  return DizzleCore.is(selector, ele);
	};
...
//# sourceMappingURL=domq.bundled.umd.js.map
